...
public class NoActivatedStroma extends ExampleCell {
    public static void main(String[]args) throws IOException {
        ...
        // name results folder
        String resultsFolder = "C:\\MyFiles\\PHD Data\\NoActivatedStroma\\";
        ...
        for (int k = 0; k < 1; k++) {
            ...
            for (int i = 0; i < 1; i++) {
                ...
                int timesteps = 8000; // number of iterations of model
...
*/
                ...
                model.initialiseStroma(initialStroma, STROMA, UNREACTIVESTROMA, 0);
