...
public class IntermittentTreatment extends ExampleCell {
    public static void main(String[]args) throws IOException {
        ...
        // name results folder
        String inputFolder = "/scratch/s.tianyi.pan/HAL/input";

        // name results folder
        String resultsFolder = "/scratch/s.tianyi.pan/HAL/output";  //Includes: Data, Image, Movies
        ...
        for (int k = 0; k < 10; k++) {
            ...
            int [] treatmentVary = {31, 32, 33, 34, 35, 36, 37, 38, 39};
            for (int i = 0; i < 9; i++) {
...
//                FileIO populationsSmall = new FileIO(resultsFolder + "/Data/PopulationsSmall_" + runDateTime + "_run_" + k + "_sim_" + i + ".csv", "w");
                ...
                model.getParameters(parameters, x, y, xSmall, ySmall, xDomain, yDomain, timestepPerDay, STROMA, VESSEL, CANCER, ACTIVATEDSTROMA, QUIESCENTCANCER, UNREACTIVESTROMA, stromaNCI, stromaDieProb, stromaIMTDays
                        ...
                        , proliferationCancerSite, activationDistMeanDays, activationDistStdDevDays, deactivationDistMeanDays, deactivationDistStdDevDays, initialTreatmentDays, treatmentVary[k], holidayDaysDrug);


                // read vessel initialisation
                int[][] vesselSetUp = model.readVesselInitialisation(inputFolder + "/vesselLocations.csv", nV);
                ...
                double[][] initialStroma = model.initialStromaSetUp(inputFolder + "/locationsStroma.csv", initialStromaCount);
                ...
                double[][] initialCancer = model.initialCancerSetUp(inputFolder + "/locationsCancer.csv", initialCancerCount);

                // determine intial proliferation signal over domain
                double[] proliferationSignalInit = model.initialProliferationSignal(inputFolder + "/valuesProliferationSignal.csv", x, y);
...
*/
                    ...
                    int[] treatmentTimestep = model.treatmentScheduleTimesteps(timestepPerDay, treatmentVary[k], holidayDaysDrug);
...
/*                    if (j % 100 == 0) {
                        ...
                        //model.recordNeighbourInformation(i, j, k, x, y, xSmall, ySmall, runDateTime, CANCER, ACTIVATEDSTROMA, UNREACTIVESTROMA);
                    }
*/
